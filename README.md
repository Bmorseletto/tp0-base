...
### Ejercicio 2:
Para este ejercicio se modifico el generador de .yaml para agregar los configs de el cliente y del servidor como volumenes en los containers de las imagenes